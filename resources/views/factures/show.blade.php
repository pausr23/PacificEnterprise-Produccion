...
<a href="{{ route('factures.history') }}" class="font-main ml-32 xxs:ml-[36%] text-white w-[30%] secondary-color hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg px-5 py-2.5 text-center">Regresar</a>

<div class="grid container py-8 rounded-xl secondary-color mx-auto lg:w-[30%] md:w-[60%] xxs:w-[90%] text-center text-white mb-5 md:mt-6 xxs:mt-12">
