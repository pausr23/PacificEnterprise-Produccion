        ...
        <div class="secondary-color h-auto">
            ...
            <form method="POST" action="{{ route('factures.invoice') }}" id="order-form">
                ...
                <div class="grid grid-cols-1 mb-2">
                    ...
                    <textarea class="secondary-color border border-gray-300 text-sm rounded-lg block p-2.5 text-white lg:w-52 md:w-20 mx-auto overflow-auto" name="note" cols="30" rows="3" placeholder="Notas adicionales"></textarea>
                </div>
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-white rounded-md lg:w-56 md:w-40 h-8 mt-5 mb-5 hover:bg-gray-200 active:bg-gray-300 transition duration-150">
