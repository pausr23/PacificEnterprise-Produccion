...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-[20%,60%] gap-16">
        <img class="w-80 mx-auto mb-10" src="https://i.ibb.co/KX69vv5/Pacific-Enterprise.png" alt="Pacific-Enterprise" border="0">
    ...
    <div>
        <div class="grid grid-cols-2 lg:gap-16 md:gap-4">
            ...
            <div class="grid content-end mb-4 lg:ml-0">
                <a class="lg:text-base md:text-sm lg:ml-16 md:ml-24 md:-mr-20 font-bold flex items-right justify-center py-3 lg:w-60 md:w-36 secondary-color text-white rounded-xl text-center hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-gray-100" href="{{ route('admin.create') }}">
                    Agregar un Nuevo Usuario
                </a>
            </div>
        </div>

        <div class="w-full md:w-[70%] mx-auto grid gap-16">
