...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-[20%,60%] gap-16">
        <img class="w-80 mx-auto mb-10 lg:block hidden xxs:mb-3" src="https://i.ibb.co/KX69vv5/Pacific-Enterprise.png" alt="Pacific-Enterprise" border="0">
                ...
                <table class="w-full rounded-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b text-white text-center xxs:text-sm border-neutral-200 dark:border-white/10">
                            ...
                            <td>{{ $user->title }}</td>
                            <td class="py-6">
                                <a class="bg-cyan-200 rounded-lg text-black font-semibold px-4  xxs:text-xs py-2 me-2 hover:bg-cyan-500 focus:ring-4 focus:outline-none focus:ring-cyan-200" href="{{ route('admin.show', ['id' => $user->id]) }}">Ver más</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
