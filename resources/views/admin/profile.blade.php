...
@section('content')
    ...
    <div class="grid grid-cols-2 w-[20%] md:w-[60%] xxs:w-[80%] gap-x-4 mx-auto xxs:mt-10 xxs:mb-4">
        <!-- Return Button -->
        <a class="p-4 secondary-color xxs:-mt-6 xxs:mb-1 text-white font-main font-semibold hover:bg-cyan-500 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center self-center" href="{{ route('factures.ordering') }}">
            Volver
        </a>
