...
@section('content')
    ...
    <div class="lg:grid m-20 rounded-xl secondary-color lg:w-[60%] sm:w-[80%] mx-auto">
        <div class="grid lg:grid-cols-[20%,80%] p-8">
            ...
            <div class="ml-10 grid lg:grid-cols-2 xxs:grid-cols-1 items-start">
                ...
                @if(Auth::check() && Auth::user()->job_titles_id == 1)
                    <div class="grid">
                        <a class="mb-3 font-main justify-self-end text-white lg:py-2 xxs:mt-3 md:py-5 md:w-full lg:h-auto md:h-auto lg:w-[60%] bg-pink-500 hover:bg-pink-700 font-medium rounded-lg text-center md:px-3 xxs:px-1" href="{{ route('admin.users') }}">Administrador de Usuarios</a> 
                        <a class="font-main justify-self-end text-white lg:py-2 xxs:mt-3 md:py-5 md:w-full lg:h-auto md:h-auto lg:w-[60%] bg-pink-500 hover:bg-pink-700 font-medium rounded-lg text-center md:px-3 xxs:px-1" href="{{ route('information.index') }}">Administrador de Información</a>                   
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 w-[20%] xxs:w-full gap-x-4 mx-auto xxs:mx-2 xxs:-mt-6 xxs:mb-4">
